...
namespace FLFlight
{
    public class SimpleCameraRig : MonoBehaviour
    {
        ...
        private void MoveCamera()
        {
            ...
            var targetRigRotation = Quaternion.LookRotation(ship.forward, ship.up);
            transform.rotation = Quaternion.Lerp(transform.rotation, targetRigRotation, smoothSpeed *Time.deltaTime);
        }
    }
}
